...
def load_esm_model(model_name, local_esm_dir="esm_cache/ckpts"):
...
def compute_ESM_embeddings(
    ...
    assert model_name.startswith("esm2")
...
def pdb_sequences_iterator(
    input_path="pdb_seq.csv",
    save_path="pdb_labels_seqs.csv",
    start_id=0,
    end_id=-1,
):
...
def main():
    ...
    pdb_seq_path = "pdb_seq/pdb_seq.csv"
    pdb_seq_label_path = "pdb_seq/pdb_labels_seqs.csv"
