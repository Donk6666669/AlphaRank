...
class Experiment:
    ...
    def best_ckpt_path(self):
        ckpts = [
            ckpt
            for ckpt in  list(sorted(self.ckpt_dir.glob("*.ckpt")) + sorted(self.ckpt_dir.glob("*.pt")))
    ...
    def ckpt_path(self, ckpt_name):
        ...
        elif (self.ckpt_dir / f"{ckpt_name}.ckpt").exists():
            ckpt_path = self.ckpt_dir / f"{ckpt_name}.ckpt"
        elif (self.ckpt_dir / f"{ckpt_name}").exists():
            ckpt_path = self.ckpt_dir / f"{ckpt_name}"

        if ckpt_path is not None and ckpt_path.exists():
            return ckpt_path
        else:
            raise ValueError(f"ckpt {ckpt_name} does not exist")
