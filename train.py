...
from protenix.utils.exptool import (
    prepare_trainer_config,
    print_config,
    register_omegaconf_resolver,
    try_resume,
)
from protenix.utils.systool import try_finish_wandb

# set WANDB_CONSOLE=off to avoid writing massive progress bars to logs
...
def main(cfg: DictConfig) -> None:
    ...
    # Testing
    if cfg.run_test:
        trainer.test(pipeline, datamodule, ckpt_path="last")
